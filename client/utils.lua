...
Citizen.CreateThread(function()
    ...
    ESX.TriggerServerCallback('ak47_cookiesv2:getconfig', function(result)
        Config = result
    end)
...
RegisterNetEvent('ak47_cookiesv2:openbossaction')
AddEventHandler('ak47_cookiesv2:openbossaction', function()
...
RegisterNetEvent('ak47_cookiesv2:notify')
AddEventHandler('ak47_cookiesv2:notify', function(msg)
    ESX.ShowNotification(msg)
end)

RegisterNetEvent('ak47_cookiesv2:progress')
AddEventHandler('ak47_cookiesv2:progress', function(msg, time)
